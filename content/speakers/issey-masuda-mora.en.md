...
{{<speaker_talk title="Building trust in noisy times">}}

In the era of agents and LLMs, the reliability of an answer depends on the quality and structure of the retrieved information. In this talk, we’ll look at how to design information-retrieval pipelines and data typing that enable models to reason with verifiable context. We’ll discuss how data traceability, versioning, and explainability become critical infrastructure for trust: not only in what AI says, but in how it gets there.
